...
require('dotenv').config(); // Permite leer la variable de Render
const app = express();

app.use(express.json());
app.use(cors());

// CONEXIÓN SEGURA USANDO TU VARIABLE DE ENTORNO DE RENDER
...
// --- RUTAS GENERALES, REGISTRO Y LOGIN ---
...
// === NUEVA RUTA 1: ELIMINAR UN CHAT INDIVIDUAL ===
...
// === NUEVA RUTA 2: ELIMINAR LA CUENTA COMPLETA ===
app.delete('/api/auth/users/:id', async (req, res) => {
    try {
        ...
        // Eliminar todos los chats que le pertenecen a este usuario
